        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                options={{
                  ...
                  scales: {
                    ...
                    y: {
                      ...
                      max: 100,
                      ticks: { color: '#9ca3af' },
                      title: { text: 'Percentage/GB', display: true, color: '#9ca3af' }
                    }
                  }
                }}
              />
          ...
          <div className="bg-gray-800 p-6 rounded-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-700 p-4 rounded-lg">
                <h3 className="text-emerald-400 font-medium">Dedicated Memory</h3>
                <p className="text-2xl text-white">
          ...
          <div className="lg:col-span-2 bg-gray-800 p-6 rounded-xl">
            <h2 className="text-xl font-semibold text-white mb-4">Hardware Details</h2>
